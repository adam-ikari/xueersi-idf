...
#endif
#ifdef CONFIG_SDL_BSP_XIAOMIAO
extern const esp_bsp_sdl_board_interface_t esp_bsp_sdl_xiaomiao_interface;
#endif
...
#elif CONFIG_SDL_BSP_XIAOMIAO
    ESP_LOGI(TAG, "Detected board: Xiaomiao Handheld");
    return &esp_bsp_sdl_xiaomiao_interface;
#else
